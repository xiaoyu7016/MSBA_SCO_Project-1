...
Portfolio<-dedicate_g3(c(102,99,101,98,98,104,100,101,102,94),c(5,3.5,5,3.5,4,9,6,8,9,7),c(1,2,2,3,4,5,5,6,7,8),c(12000,18000,20000,20000,16000,15000,12000,10000))
